...
namespace Server.Engines.Quests
{
    public class Carta : BaseQuest
    {
            ...
            : base()
        {
            ...
            // Dar ouro para completar missão
            AddObjective(new ObtainObjective(typeof(Gold), "Moeda de Ouro", 500, 0xEED));
            //this.AddReward(new BaseReward(typeof(Cloak), 1, "Manto de La"));
            this.AddReward(new BaseReward(typeof(CartaHakon), 1, "Carta de Recomendação"));
        }
    ...
    public class Hákon : MondainQuester
    {
