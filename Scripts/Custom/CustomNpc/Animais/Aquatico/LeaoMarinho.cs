...
{
    [CorpseName("Corpo de um Leão Marinho")]
    public class SeaLion : BaseCreature
    {
        private DateTime m_NextUptime;

        [Constructable]
        public SeaLion() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.1, 0.3)
        {
            Name = "Leão Marinho";
            Body = 221;
            BaseSoundID = 0x57;
        ...
        //public override HideType HideType { get { return HideType.HideLeather; } }
        ...
        public override void OnThink()
        {
            ...
            {
                m_NextUptime = DateTime.UtcNow + TimeSpan.FromSeconds(15);

                if (Utility.RandomDouble() < 0.5)
                {
                    Emote("*faz um som de rugido*");
                }
            }
            Tamable = true;
            ControlSlots = 1;
        ...
        public SeaLion(Serial serial) : base(serial)
        {
        }
