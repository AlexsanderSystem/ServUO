...
namespace Server.Engines.Harvest
{
    public class Mining : HarvestSystem
    {
        ...
        private Mining()
        {
            ...
            {
                new HarvestResource(20.0, 00.0, 100.0, 1007072, typeof(IronOre), typeof(Granite)),
                new HarvestResource(35.0, 25.0, 40.0, 1007073, typeof(DullCopperOre),  typeof(DullCopperGranite), typeof(DullCopperElemental)),
                new HarvestResource(45.0, 30.0, 50.0, 1007074, typeof(ShadowIronOre),  typeof(ShadowIronGranite), typeof(ShadowIronElemental)),
                new HarvestResource(55.0, 35.0, 60.0, 1007075, typeof(CopperOre), typeof(CopperGranite), typeof(CopperElemental)),
                new HarvestResource(72.0, 40.0, 70.0, 1007076, typeof(BronzeOre), typeof(BronzeGranite), typeof(BronzeElemental)),
                new HarvestResource(78.0, 45.0, 80.0, 1007077, typeof(GoldOre), typeof(GoldGranite), typeof(GoldenElemental)),
                new HarvestResource(78.0, 50.0, 90.0, 1007078, typeof(AgapiteOre), typeof(AgapiteGranite), typeof(AgapiteElemental)),
                new HarvestResource(88.0, 55.0, 100.0, 1007079, typeof(VeriteOre), typeof(VeriteGranite), typeof(VeriteElemental)),
                new HarvestResource(95.0, 59.0, 100.0, 1007080, typeof(ValoriteOre), typeof(ValoriteGranite), typeof(ValoriteElemental))
            };
            ...
            veins = new HarvestVein[]
            {
                ...
                new HarvestVein(01.2, 0.7, res[6], res[0]), // Agapite
                new HarvestVein(00.8, 0.6, res[7], res[0]), // Verite
                new HarvestVein(00.6, 0.5, res[8], res[0]), // Valorite
            };
